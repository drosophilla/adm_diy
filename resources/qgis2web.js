...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [109.866539, -8.224177, 110.975495, -7.523456], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([109.866539, -8.224177, 110.975495, -7.523456], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Administrasi DIY</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_ADM_DESA_DIY_BIG_2023_5,
    colName: 'Desa',
    zoom: 10,
    collapsed: true,
    map: map
